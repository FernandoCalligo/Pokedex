...
function App() {
  ...
  const list = PokemonList.results.map((poke, idx) => {
    return (
  ...
  <>
    <div className='cont'>
      ...
      <div className='imgcont'>
        <img src={Shiny ? pokemonData.sprites.front_default : pokemonData.sprites.front_shiny } alt={pokemonData.name} />
        <img src={Shiny ? pokemonData.sprites.back_default : pokemonData.sprites.back_shiny } alt={pokemonData.name} />
      </div>

      <button className={Shiny ? "btn active" : "btn desactived"} onClick={() => setShiny(!Shiny)}>
